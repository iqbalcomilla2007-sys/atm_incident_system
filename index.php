...
<div class="container">
    <div class="card">
        ...
        <?php if (isset($_GET['duplicate'])): ?>
            <div style="background:#f8d7da; color:#842029; padding:12px 15px; border-radius:8px; border: 1px solid #f5c2c7; margin-bottom:15px; font-size:14px; line-height: 1.5;">
                ⚠️ <b>Error:</b> এই ATM-এর জন্য ইতিমধ্যেই <strong><?= isset($_GET['vendor']) ? h($_GET['vendor']) : 'উক্ত ভেন্ডরের' ?></strong> নামে একটি ইনসিডেন্ট ওপেন আছে! <br>
                <span style="font-size: 13px; color: #dc2626;">(তবে আপনি চাইলে অন্য ভেন্ডরের নামে নতুন ইনসিডেন্ট এন্ট্রি করতে পারবেন)</span>
            </div>
        <?php endif; ?>
