...
<<<<<<< HEAD
    ...
    if ($search !== '') {
        ...
        $lk = "%$search%";
        for ($i = 0; $i < 9; $i++) { $params[] = $lk; $types .= 's'; }
    }
...
<<<<<<< HEAD
                ...
                <th>DVR Model</th>
                <th>DVR Serial</th>
                <th>DVR Install Date</th>
                <th>Camera Channels</th>
                <th>Camera Vendor</th>
                <th>Camera Install Date</th>
                <th>HDD Size (TB)</th>
                <th>HDD Serial</th>
                <th>HDD Vendor</th>
...
<<<<<<< HEAD
            ...
            echo "<td>" . h($row['dvr_brand']) . "</td>";
            echo "<td>" . h($row['dvr_model']) . "</td>";
            echo "<td>" . h($row['dvr_serial']) . "</td>";
            echo "<td>" . h($row['dvr_inst_date']) . "</td>";
            echo "<td>" . h($row['camera']) . "</td>";
            echo "<td>" . h($row['camera_vendor']) . "</td>";
            echo "<td>" . h($row['camera_inst_date']) . "</td>";
            echo "<td>" . h($row['hdd_size_tb']) . "</td>";
            echo "<td>" . h($row['hdd_serial']) . "</td>";
