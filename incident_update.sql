...
CREATE TABLE `cctv_hard_disk_procurement` (
  `id` int(11) NOT NULL,
  `tender_notice_no` varchar(100) NOT NULL,
  `notice_date` date NOT NULL,
  `vendor_name` varchar(150) NOT NULL,
  `quotation_status` varchar(100) DEFAULT 'Awaiting Quotation',
  `quotation_ref` varchar(100) DEFAULT NULL,
  `quotation_amount` decimal(12,2) DEFAULT 0.00,
  `process_status` enum('Notice Published','Quotation Submitted','Technical Evaluation Done','Work Order Issued','Hard Disk Delivered','QC Passed','Stock Received','Installed at Booth','Bill Submitted','Forwarded to FAD') DEFAULT 'Notice Published',
